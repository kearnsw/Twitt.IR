var MG_angular = angular.module('metricsGraphics', []);
MG_angular.controller('MGController', function($scope, $location) {
    (function (root, factory) {
        ...
        function set_min_max_y(args) {
            ...
            if (args.y_scale_type === 'log') data = data.filter(function (d) {
        ...
        (function () {
            ...
            function mg_nest_data_for_voronoi(args) {
                return d3.nest()
                    ...
                    .entries(d3.merge(args.data.map(function (d) {
                        return d;
                    })))
                    .map(function (d) {
                        return d.values;
                    ...
                    if (this.is_vertical) {
                        ...
                        if (args.baseline_accessor) {
                            ...
                            baseline_marks
                                ...
                                .attr('y1', function (d) {
                                    return args.scales.Y(d[args.baseline_accessor]);
                                })
                                .attr('y2', function (d) {
                                    return args.scales.Y(d[args.baseline_accessor]);
                                });
